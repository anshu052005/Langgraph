...
def evaluate_language(state: UPSCState):
    ...
    prompt = (
        "Evaluate the language quality of the following essay and "
...
Language feedback:
{state.get("language_feedback","")}

Depth of analysis feedback:
{state.get("analysis_feedback","")}
...
if __name__ == "__main__":
    ...
    print("\nIndividual Scores:")
    print(result.get("individual_scores", []))

    print("\nAverage Score:")
    print(result.get("avg_score", 0.0))